...
#define ENDSTOPPULLUPS
  ...
  #define ENDSTOPPULLUP_ZMIN     //Dave .... disable this only if using inductance probe with voltage divider -- as of 2020-01-12
...
// @advi3++: Sets the directions for BLTouch
  ...
  #define X_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
  #define Y_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
  #define Z_MIN_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.    // Dave ... make this false only if using inductance probe with voltage divider -- as of 2020-01-12
  #define X_MAX_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
  #define Y_MAX_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
  #define Z_MAX_ENDSTOP_INVERTING true // set to true to invert the logic of the endstop.
  #define Z_MIN_PROBE_ENDSTOP_INVERTING true // set to true to invert the logic of the probe. // Dave ... make this false only if using inductance probe with voltage divider -- as of 2020-01-12
  #endif
...
#define FIX_MOUNTED_PROBE            // Dave ... added because this only gets defined for Mark II as of 2019-12-31 (see #ifdef above)
...
#define INVERT_E0_DIR true        // Dave.... too lazy to reverse the wiring of the motor so I just change to TRUE.... 2020-10-20
 ...
 */
#ifdef ADVi3PP_PROBE                          // Dave ... FYI, you have to define this in advi3pp_defines.h .... 2019-12-31
...
#define Z_SAFE_HOMING              // Dave ... added because this only gets defined for BLTouch as of 2019-12-31 (see #ifdef above)
