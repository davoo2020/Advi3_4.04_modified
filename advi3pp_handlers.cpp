...
namespace
{
    ...
    const FlashChar* get_sensor_name(size_t index)
    {
        ...
        // assert(index < advi3pp::SensorSettings::NB_SENSOR_POSITIONS);               // Dave ... originally uncommented as of 2019-12-31
        auto dave                = F("Dave");                                          // Dave .... created a constant as of 2019-12-31
        static const FlashChar* names[advi3pp::SensorSettings::NB_SENSOR_POSITIONS] =
          {dave, teaching_tech_side, custom};                                          // Dave .... created a constant as of 2019-12-31
        return names[index];
